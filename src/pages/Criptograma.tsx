...
function MainPage() {
    ...
    return (
      ...
      <div className="h-screen flex flex-col items-center justify-center bg-emerald-950">
        ...
        {instructions && (
          <p className=' p-5 md:m-12 md:mt-64 lg:m-64 lg:mt-96 xl:m-64 xl:mt-96 text-center relative font-semibold text-2xl text-green-500'>Esse pagina foi cria para ajudar na tradução do alfabeto de Enigma do Medo, para utilizar clique em começar para abrir a teclado digite o codigo desejado e aperte ENTER.</p>
      )}
